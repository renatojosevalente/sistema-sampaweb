...
// Recuperar Alunos e Escola somente a Escola com ID = 2
$queryAlunos = "SELECT idAluno, nomeAluno FROM Aluno WHERE idEscola = 2";
$resultAlunos = $conn->query($queryAlunos);

$queryEscola = "SELECT nomeEscola FROM Escola WHERE idEscola = 2";
